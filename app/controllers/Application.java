...
public class Application extends Controller {
    ...
    public static void register() { renderTemplate("Application/register.html"); }
    ...
    public static void donarBaixaEspai(int id){
        SPACEMEETING s = SPACEMEETING.find("byID", id).first();
            if(s != null){
                for (MEETING m: s.Listmeetings){
                    m.delete();
                }
                s.delete();
            }
